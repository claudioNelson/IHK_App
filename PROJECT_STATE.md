...
- ⬜ **Web-Redesign, Rest:** Rechtsseiten-Optik (impressum, datenschutz, agb noch Tailwind-Grau ohne Shell/Dunkelmodus), Fragetyp-Komponenten der Pruefung (TableInput, DecisionMatrix, CodeCorrection, FillBlanks, DiagramTool, ImageLightbox fest hell, altes Indigo `#7C6DFF` hart), `not-found.tsx`, Metadata-Durchgang, `sitemap.ts` pruefen, „4 von 5 waehlen" auswerten, Multiple-Choice zeigt Textfeld, Lektionsdauern geschaetzt, gekuendigte Stripe-Abos zeigen „Verlaengert sich am". Supabase: Passwort-Mindestlaenge in Auth-Settings auf 8.
