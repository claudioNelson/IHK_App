...
- ⬜ **Web-Redesign, Rest:** Fragetyp-Komponenten der Pruefung (TableInput, DecisionMatrix, CodeCorrection, FillBlanks, DiagramTool, ImageLightbox fest hell, altes Indigo `#7C6DFF` hart), `not-found.tsx`, Metadata-Durchgang, `sitemap.ts` pruefen, „4 von 5 waehlen" auswerten, Multiple-Choice zeigt Textfeld, Lektionsdauern geschaetzt, gekuendigte Stripe-Abos zeigen „Verlaengert sich am", Hero-Optionen (Kennzahlen im Hero, zweiter Screenshot, Countdown-Pille). Ideen-Liste Inhalte (24.09.): Struktogramm/Pseudocode-Kurs, Web-Pruefungen aus dem App-Bestand, Schwaechen-Analyse im Profil, WiSo/AP1-Luecken, 19 leere „kernthema"-Module in der DB aufraeumen; App-seitig (1.7.2) kleiner Diagramm-Kurs, der zum Ueben auf den Desktop/Web verweist.
