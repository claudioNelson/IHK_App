...
export const ae1: Exam = {
    ...
    fachrichtung: "ae",
    difficulty: "mittel",
    tags: ["uml-aktivität", "er-diagramm", "sql", "algorithmen", "pseudocode"],
    sectionsToChoose: 4,
...
Hinweis: Verwenden Sie die Chen-Notation oder die Krähenfuß-Notation.`,
                    type: "diagram",
                    points: 25,
                    hint: "Identifizieren Sie zuerst die Entitäten (Kunde, Sendung, Transport, Fahrzeug, Fahrer). Welche Beziehungen sind n:m (z.B. Sendung↔Transport)? n:m-Beziehungen brauchen eine eigene Beziehung im ER-Diagramm.",
                    diagram: { mode: "er" },
                    tags: ["er-diagramm", "datenmodell", "kardinalitäten"],
                },
            ],
        },
        {
...
- Auswahlkriterien: Transport_ID = 1 UND Datum = '02.12.2024'`,
                    type: "code",
                    points: 8,
                    hint: "Sie brauchen 4 Tabellen: Kunde → Buchung → Transport_Datum → Transport. Welcher JOIN verbindet sie? Wie sortiert man aufsteigend?",
...
Hinweis: Es wird davon ausgegangen, dass der Divisor immer > 0 ist.`,
                    ...
                    tags: ["sql", "count", "prozent", "aggregation"],
                },
                {
                    id: "hs5-c",
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`,
                    ...
                    tags: ["sql", "sum", "aggregation", "where"],
                },
                {
                    id: "hs5-d",
