...
export const si2: Exam = {
    ...
    fachrichtung: "si",
    difficulty: "schwer",
    tags: ["server", "raid", "dhcp", "firewall", "ipv6"],
    sectionsToChoose: 4,
...
Erläutern Sie zwei wesentliche Vorteile, die IMAP gegenüber POP3 bietet.`,
                    ...
                    tags: ["email", "imap", "pop3", "protokolle"],
                },
                {
                    id: "hs2-b",
...
Erläutern Sie eine entsprechende Möglichkeit unter Angabe des zu verwendenden Protokolls.`,
                    ...
                    tags: ["email", "tls", "verschlüsselung", "ports"],
                },
                {
                    id: "hs2-c",
...
Ergänzen Sie die noch fehlenden Beschriftungen für die Schritte 2 bis 4.`,
                ...
                },
                {
                    ...
                    tags: ["dhcp", "konfiguration", "netzwerk"],
                },
                {
                    id: "hs2-e",
...
Erläutern Sie die Funktionsweise eines Honeypots.`,
                    ...
                    tags: ["it-sicherheit", "honeypot", "intrusion-detection"],
                },
            ],
        },
        {
...
Beschreiben Sie die organisatorische Maßnahme, die diesen Schutz bewirkt.`,
                    ...
                    tags: ["dmz", "firewall", "netzwerksicherheit"],
                },
                {
                    id: "hs3-c",
...
Erläutern Sie die Regeln 1, 2 und 99.`,
                    ...
                    tags: ["firewall", "regeln", "ports", "http", "https"],
                },
                {
                    id: "hs3-d",
...
Nennen Sie die Bezeichnung eines Feldes im TCP-Header, welches nur von der SPI-Firewall analysiert wird.`,
                    ...
                    tags: ["firewall", "spi", "tcp", "stateful"],
                },
                {
                    id: "hs3-e",
...
Nennen Sie die Benutzergruppen, die berechtigt sind, Dateien zu löschen.`,
                    ...
                    tags: ["berechtigungen", "ntfs", "dateisystem"],
                },
                {
                    id: "hs4-ab",
                    ...
                    tags: ["berechtigungen", "gruppen", "analyse"],
                },
                {
                    id: "hs4-ac",
                    ...
                    tags: ["berechtigungen", "gruppen", "kumulation"],
                },
                {
                    id: "hs4-ad",
...
Erstellen Sie die entsprechende Anweisung.`,
                    ...
                    tags: ["berechtigungen", "kommandozeile", "cli"],
                },
                {
                    id: "hs4-b",
...
- die Syntax der if-Anweisung: if (logische Bedingung) { ... } else { ... };`,
                    ...
                    tags: ["passwort", "logik", "boolesche-algebra"],
                },
            ],
        },
        {
...
Geben Sie die Erläuterung sinngemäß in Deutsch wieder.`,
                    ...
                    tags: ["ipv6", "link-local", "adressierung"],
                },
                {
                    id: "hs5-ab",
...
Geben Sie die Erläuterung sinngemäß in Deutsch wieder.`,
                    ...
                    tags: ["ipv6", "unique-local", "private-netzwerk"],
                },
                {
                    id: "hs5-ac",
...
Geben Sie die Erläuterung sinngemäß in Deutsch wieder.`,
                    ...
                    tags: ["ipv6", "global-unicast", "adressierung"],
                },
                {
                    id: "hs5-ad",
...
Geben Sie die Erläuterung sinngemäß in Deutsch wieder.`,
                ...
                },
                {
                    ...
                    tags: ["ipv6", "subnetting", "berechnung"],
                },
                {
                    id: "hs5-c",
...
c-b) Ermitteln Sie die IPv6-Empfängeradresse. (3 Punkte)`,
                    ...
                    tags: ["ipv6", "header", "trace", "analyse"],
                },
                {
                    id: "hs5-d",
...
d-b) Ermitteln Sie die IPv6-Adresse für den Standardgateway. (3 Punkte)`,
                    ...
                    tags: ["ipv6", "adressierung", "konfiguration", "gateway"],
                },
            ],
        },
    ],
