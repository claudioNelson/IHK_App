// Linien-Icons fuer die Konto-Seiten (aus dem Mockup-Sprite uebernommen).
// Groesse und Farbe kommen aus konto.css (z. B. .kt-alert > svg), deshalb
// hier nur viewBox, Strich und Pfade. Immer aria-hidden, Text steht daneben.
...
const PFADE: Record<IconName, ReactNode> = {
  ...
  check: <path d="M5 12l4 4L19 6" strokeWidth="2.2" />,
  ...
  "eye-off": (
    <>
      <path d="M10.6 5.6A9.7 9.7 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-2.6 3.4M6.6 6.6C3.9 8.4 2.5 12 2.5 12S6 18.5 12 18.5a9.3 9.3 0 0 0 5.4-1.7" />
...
// Google-Logo in den Markenfarben (nur fuer den Google-Knopf).
