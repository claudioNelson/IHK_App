...
export const lektionen: Lektion[] = [
  ...
  { nr: 7, slug: "lektion-7", titel: "Listen & Dictionaries", status: "live" },
  { nr: 8, slug: "lektion-8", titel: "Funktionen", status: "live" },
  { nr: 9, slug: "lektion-9", titel: "Fehler & Debugging", status: "live" },
  { nr: 10, slug: "lektion-10", titel: "Klassen-Basics (OOP)", status: "live" },
  { nr: 11, slug: "lektion-11", titel: "🎮 Projekt: Snake", status: "live" },
  { nr: 12, slug: "lektion-12", titel: "Abschluss & IHK-Pseudocode", status: "live" },
];
