...
1. **Antwortlängen:** Antworten sind KURZ: Ziel 25–55 Zeichen, Maximum 70 (Altbestand: Schnitt 38). Alle vier Antworten ähnlich lang (längste ≤ 1,4× kürzeste), die richtige nie die längste. Nominalstil ist erlaubt. (Lehre vom 17.09.: Der Fix vom 09.09. hatte die falschen Antworten an die lange richtige angeglichen; Ergebnis waren vier lange Antworten, in der Arena unlesbar. 1.320 Antworten mussten nachgekürzt werden.) Zusätzlich gilt: Jede falsche Antwort liegt zwischen 0,7× und 1,3× der Länge der richtigen. Bei ungefähr einem Viertel der Fragen ist bewusst eine falsche Antwort die längste. Falsche Antworten haben dieselbe Satzform und Tiefe wie die richtige („… – z. B. …“), keine Unsinns-Antworten wie „Der Drucker“. Automatisch prüfen, nicht nach Gefühl.
