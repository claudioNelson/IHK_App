// lib/screens/learning/raid_practice_screen.dart
...
class RaidPracticeScreen extends StatefulWidget {
  final int moduleId;
  final String moduleName;

  const RaidPracticeScreen({
    super.key,
  ...
  @override
  State<RaidPracticeScreen> createState() => _RaidPracticeScreenState();
}

class _RaidPracticeScreenState extends State<RaidPracticeScreen> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final data = await _supabase
          ...
          .eq('question_type', 'raid_calculation')
          .order('id');
