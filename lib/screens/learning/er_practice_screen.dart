// lib/screens/learning/er_practice_screen.dart
...
class ErPracticeScreen extends StatefulWidget {
  final int moduleId;
  final String moduleName;

  const ErPracticeScreen({
    super.key,
  ...
  @override
  State<ErPracticeScreen> createState() => _ErPracticeScreenState();
}

class _ErPracticeScreenState extends State<ErPracticeScreen> {
