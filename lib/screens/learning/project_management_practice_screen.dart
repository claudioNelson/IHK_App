// lib/screens/learning/project_management_practice_screen.dart
...
class ProjectManagementPracticeScreen extends StatefulWidget {
  final int moduleId;
  final String moduleName;

  const ProjectManagementPracticeScreen({
    super.key,
  ...
  @override
  State<ProjectManagementPracticeScreen> createState() =>
      _ProjectManagementPracticeScreenState();
}

class _ProjectManagementPracticeScreenState
    extends State<ProjectManagementPracticeScreen> {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: _green.withOpacity(0.08), blurRadius: 16, offset: const Offset(0, 6))],
            ),
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('Frage', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: _green)),
                  ],
                ),
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: showResult ? (isCorrect ? Colors.green.shade50 : Colors.red.shade50) : (isSelected ? Colors.green.shade50 : Colors.white),
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: showResult ? (isCorrect ? Colors.green : Colors.red) : (isSelected ? _green : Colors.grey.shade200),
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_green.withOpacity(0.9), _green, const Color(0xFF4ADE80)],
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Projektmanagement Übungen',
  ...
  Widget _buildProgressBar() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
        boxShadow: [BoxShadow(color: _green.withOpacity(0.08), blurRadius: 10, offset: const Offset(0, 2))],
      ),
      child: Column(
        children: [
          Row(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.inbox_outlined, size: 56, color: _green),
          ),
