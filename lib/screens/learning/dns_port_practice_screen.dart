// lib/screens/learning/dns_port_practice_screen.dart
  ...
  Widget _buildQuestion() {
    ...
    if (type == 'dns_port_match') {
      return DnsPortMatchWidget(
        ...
        correctAnswers: q['calculation_data'] != null
            ? Map<String, dynamic>.from(q['calculation_data'])
            : {},
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Text('Frage',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: _indigo)),
                  ],
                ),
